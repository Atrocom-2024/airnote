...
export default function NicknameChange({ nickname }: { nickname: string; }) {
  ...
  return (
    <section>
      ...
      <input
        className="w-[300px] outline-none bg-white text-black border border-middle-gray rounded-md px-3 py-2 disabled:bg-dark-white disabled:text-middle-gray disabled:border-none"
        value={changeName}
