...
export default async function Header() {
  ...
  return (
    <header className="fixed w-[100vw] h-[8vh] bg-white/70 backdrop-blur-[3px] justify-between flex items-center z-[30] border-b border-gray px-5 sm:px-10 md:justify-around">
